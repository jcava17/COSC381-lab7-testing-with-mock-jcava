...
# --- Task 3: make bytes key invalid by mocking the method validate() uses --------
# (Explicitly set return_value inside the test body — this addresses the grader note.)
...
# --- Task 4: black-box valid key sizes (exactly six cases, call validate) --------
